  ...
  paths: {
    ...
    '/api/attendance/check-in': {
      post: {
        ...
        description:
          'Record employee check-in for the current day based on configured timezone.',
        responses: {
          '200': {
                ...
                schema: {
                  ...
                  properties: {
                    attendance: {
                      ...
                      required: ['id', 'date', 'checkIn', 'status'],
                    },
                  },
                  required: ['attendance'],
                },
    ...
    '/api/attendance/today': {
      get: {
        ...
        description:
          'Retrieve the attendance record for the current authenticated employee for today.',
        responses: {
          '200': {
    ...
    '/api/attendance/history': {
      get: {
        ...
        description:
          'Retrieve paginated attendance history for the authenticated employee.',
        parameters: [
          {
            name: 'limit',
            in: 'query',
    ...
    '/api/payroll/salary-structure': {
      get: {
        ...
        description:
          'Retrieve salary structure configurations (Employee views own; HR can target employee by header).',
        parameters: [
          {
            name: 'employeeId',
            in: 'header',
