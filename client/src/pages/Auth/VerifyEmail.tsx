      ...
      <div className="auth-container">
        ...
        {status === 'success' && (
          <div className="text-center" style={{ padding: 'var(--space-6) 0' }}>
            ...
            >
              Your email address has been verified successfully. You can now log
              in to your account.
            </p>
            <Button
              variant="primary"
        ...
        {status === 'error' && (
          <div className="text-center" style={{ padding: 'var(--space-4) 0' }}>
            ...
            <h2
              ...
              style={{ fontSize: '0.875rem', marginBottom: 'var(--space-2)' }}
            >
              Need a new link?
            </h2>
        ...
        {status === 'pending' && (
          <div className="text-center" style={{ padding: 'var(--space-4) 0' }}>
            ...
            >
              ...
              {email ? ` (${email})` : ''}. Please check your inbox and click
